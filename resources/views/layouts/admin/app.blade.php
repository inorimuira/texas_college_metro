...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
        ...
        <div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
            ...
            <img src="{{ url(asset('assets/image/logo.png')) }}" class="w-10 flex-none">
            <strong class="capitalize ml-1 flex-1">Texas College</strong>
            ...
            <!-- left -->
            <div id="navbar" class="animated md:hidden md:fixed md:top-0 md:w-full md:left-0 md:mt-16 md:border-t md:border-b md:border-gray-200 md:p-10 md:bg-white flex-1 pl-3 flex flex-row-reverse items-center md:flex-col md:items-center">
