    ...
    <div class="w-full flex justify-center items-center">
        <div class="w-full grid grid-cols-2 gap-6 md:px-12">
            ...
            <div class="col-span-2 flex items-center">
                <ol
                    class="flex justify-center items-center w-full text-sm font-medium text-center text-gray-500 sm:text-base">
                    <li
            ...
            <form class="w-full col-span-2 grid grid-cols-1 gap-2 md:gap-4">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="dropzone-file"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Klik untuk unggah</span>atau letakkan file disini</p>
                ...
                <div class="col-span-2 flex justify-between">
                    <x-button-primary type="submit"
                        class="flex items-center before:content-['<'] before:me-2">Kembali</x-button-primary>
                    <x-button-primary type="submit"
                        class="flex items-center after:content-['>'] after:ms-2">Berikutnya</x-button-primary>
                </div>
            </form>
        </div>
    </div>
