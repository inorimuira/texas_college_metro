            ...
            @if ($kelasReguler || $kelasUnggulan)
                @if ($kelasReguler)
                    <form class="w-full col-span-2 grid grid-cols-1 gap-2 md:gap-4">
                        <span class="col-span-2 text-center font-bold text-base">Biaya kursus: Rp 1.700.000 satu
                            semester (6 Bulan)</span>
                        <h1 class="col-span-2 text-center text-secondary">Wajib membayar biaya pendaftaran sejumlah
                            <span class="font-semibold text-slate-800">Rp 100.000</span>. Jika melakukan pelunasan akan
                            mendapatkan
                        ...
                        <div class="col-span-2 my-6">
                            ...
                            <div class="flex justify-between mt-6">
                                ...
                                <x-button-primary type="submit" @click="isModalOpen = true"
                ...
                @if ($kelasUnggulan)
                    <form class="w-full col-span-2 grid grid-cols-1 gap-2 md:gap-4">
                        <span class="col-span-2 text-center font-bold text-base">Biaya kursus: Rp 1.500.000 satu
                            semester (16 Pertemuan)</span>
                        <h1 class="col-span-2 text-center text-secondary">Wajib membayar biaya pendaftaran sejumlah
                            <span class="font-semibold text-slate-800">Rp 100.000</span>. Jika melakukan pelunasan akan
                            mendapatkan
                            <span class="text-red-500 font-semibold"> potongan Rp 200.000</span>
                        ...
                        <div class="col-span-2 my-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6">
                                <div class="w-full flex flex-col gap-2 md:gap-4">
                                    ...
                                    <x-select-option option1="Lunas" option2="Angsuran">Pembayaran</x-select-option>
                                    <x-select-option option1="BNI 12234567 An Nurul"
                                        option2="BRI 12234567 An Siti">Pilih
                                        bank
                                        tujuan</x-select-option>
                                </div>
                                <div x-data="{ fileName: '' }" class="flex items-center justify-center w-full">
                            ...
                            <div class="flex justify-between mt-6">
                                <x-button-primary type="button"
                                    href="{{ route('IsiBiodata', ['kelasUnggulan' => true]) }}"
                                    iconType="iconArrowLeft" :iconBeforeText="true">Kembali</x-button-primary>
                                <x-button-primary type="submit" iconType="iconArrowRight" :iconAfterText="true"
                                    @click="isModalOpen = true">Simpan</x-button-primary>
                            </div>
                        </div>
                    </form>
                @endif
