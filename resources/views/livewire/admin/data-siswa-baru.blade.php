<div class="w-full" x-data="{ isPreviewSiswa: false, kelasUnggulan: true, kelasReguler: false, courseDone: true }">
    <div class="p-8">
        <!-- Manage Chapter Section -->
        <div class="bg-white shadow-md rounded-md p-6" x-cloak>
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Data Siswa Baru</h1>
                </div>
                <div class="">
