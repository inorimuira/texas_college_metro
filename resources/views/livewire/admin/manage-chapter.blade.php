    ...
    <div class="p-8">
        ...
        <div x-show="!isManagingModule" x-cloak class="bg-white shadow-md rounded-md p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <div>
                    <button @click="isPopupOpenChapter = true" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">Tambah Chapter</button>
                </div>
            </div>
            ...
            @else
                @foreach ($chapters as $chapter)
                    <div class="flex flex-col border rounded-md divide-y">
                        ...
                        <div
                            x-show="openChapters['{{ $chapter->id }}']"
                            x-cloak
                        >
                            @php
                            ...
                            @if ($chapterModules->isNotEmpty())
                                @foreach ($chapterModules as $module)
                                    <div class="flex justify-between items-center px-4 py-2 border-b hover:bg-gray-100">
                                        ...
                                        <div class="flex space-x-2">
                                            <button class="text-black mr-2" wire:click="manageModule({{ $module->id }})">
                                                <svg version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    viewBox="0 0 32 32" xml:space="preserve" width="20  px" height="20px">
                                                    <path fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M11.3,26.5L4,28l1.5-7.3L21.6,4.5c0.8-0.8,2.1-0.8,2.9,0l2.9,2.9c0.8,0.8,0.8,2.1,0,2.9L11.3,26.5z"/>
                                                    <line fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" x1="18.7" y1="7.5" x2="24.5" y2="13.3"/>
                                                </svg>
                                            </button>
                            ...
                            <div class="flex justify-center py-3">
                                <button wire:click="modalOpenModule({{ $chapter->id }})" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">Tambah Module</button>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div x-show="isPopupOpenChapter" x-cloak class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-5 relative">
                ...
                <form wire:submit.prevent="tambahChapter">
                    <div class="mb-4">
                        <label for="chapter_name" class="block text-sm font-medium text-gray-700 mb-2">Nama Chapter</label>
                        <input
                            type="text"
        ...
        <!-- Popup Tambah Modul -->
        <div x-show="isPopupOpenModule" x-cloak class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-5 relative">
                <!-- Close Button -->
                ...
                <form wire:submit.prevent="tambahModule">
                    <div class="mb-4">
                        <label for="module_name" class="block text-sm font-medium text-gray-700 mb-2">Nama Modul</label>
                        <input
                            type="text"
