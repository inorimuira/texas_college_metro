    ...
    <div class="mt-20 w-full p-4 md:px-6 xl:px-20 space-y-3">
        ...
        <div class="bg-slate-50 flex flex-col gap-8 px-3 py-2 md:px-4 md:py-3 lg:px-12 lg:py-8 rounded-lg">
            <div class="col-span-4 flex flex-col">
                ...
                <span class="text-base font-medium text-slate-500">This is a summary of this semester</span>
            </div>
            <table class="w-full text-center table-auto">
                <thead>
                    <tr class="border-t border-t-slate-400">
                        <th class="py-2 px-4 border-b border-slate-400">Chapter</th>
                ...
                <tbody>
                    <tr>
                        <td class="py-2 px-4 border-b border-slate-400">Past Tense</td>
                        <td class="py-2 px-4 border-b border-slate-400 text-slate-500">90</td>
                        <td class="py-2 px-4 border-b border-slate-400 text-slate-500">2023-10-01</td>
